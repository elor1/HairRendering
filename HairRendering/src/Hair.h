...
public:
	...
	void SetAttributes(glm::vec3 colour = glm::vec3(0.6f, 0.4f, 0.3f), int numGroupHairs = 64, float groupSpread = 0.2f, float hairRadius = 0.0025f, float noiseAmplitude = 0.1f, int numSplineVertices = 20);
