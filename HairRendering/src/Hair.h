...
public:
	...
	void SetAttributes(glm::vec3 colour = glm::vec3(0.3f, 0.2f, 0.15f), int numGroupHairs = 64, float groupSpread = 0.2f, float hairRadius = 0.004f, float noiseAmplitude = 0.1f, int numSplineVertices = 20);
